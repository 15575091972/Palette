<template>
	<div style="margin-left:4%">
		<div>
			...
			<el-row>
				<el-col :span="6">
					<div style="font-size:28px;font-family:华文新魏;margin-top:24px;margin-left:24px;">艺术长廊 &nbsp;&nbsp;绘画</div>
				</el-col>
		...
		<!-- 图片列表 -->
		<el-row   >
			<div v-for="v in PaintPictureList" :key="v.value"@click="gotogoodspage(v.artId)" >
				<el-col :span="5" style="margin-left: 2%;" class="image__place">
					<el-card :body-style="{ padding: '15px' }" style="height: 345px;margin-top: 30px;">
						<div id="homeimage">
